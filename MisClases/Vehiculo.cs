...
namespace p1bpoo.MisClases
{
    public class Vehiculo
    {
        ...
        protected virtual int VelocidadMaxima { get; set; } //velocidad maxima del vehiculo (en km/h)
        protected virtual int CapacidadTanque { get; set; } //capacidad del tanque de combustible (en galones)
        protected virtual double ConsumoCombustible { get; set; } //consumo de combustible por kilometro(en galones/km)
        ...
        public void InformacionVehiculo()
        {
            ...
            Console.WriteLine("Consumo de Combustible {0} galones por KM", ConsumoCombustible);
